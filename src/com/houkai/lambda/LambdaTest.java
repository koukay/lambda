...
public class LambdaTest {
    public static void main(String[] args) throws Exception {
       ...
       /* Runnable runnable3 = ()-> System.out.println("running3....");
        ...
        /*Callable<String> c2 = ()->{return "houkai2";};
        System.out.println(c2.call());*/

        /*Callable<String> c3 = ()->"houkai3";
        ...
        * */
        ...
        /**
         * Supplier没有入参,必须有一个出参
         */
        /*Supplier<String> s1 = ()->{return "houkai";};
        Supplier<String> s2 = ()->"houkai2";
        System.out.println(s1.get());
        System.out.println(s2.get());*/
        /**
         * Consumer没有出参,必须有一个入参
         */
        /*Consumer<String> c11 = (str) -> System.out.println(str);
        c11.accept("beijing");
        System.out.println("---------------");*/
        BiFunction<String,String,Integer> bf = (a, b)->a.length()+b.length();
        System.out.println(bf.apply("test", "好帅"));

   /*     Runnable runnable1 = ()-> System.out.println(get());
//        Runnable runnable1 = ()->get();
//        Runnable runnable2 = ()->exec();
        //run方法没有返回值,所以写返回值会报错
